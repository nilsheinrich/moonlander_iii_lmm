...
```
zero correlation is favored by BIC (and by AIC). Therefore. proceeding with m_varyingSlope_complex_zc.
...
We find **no** significance for input noise. We however find that **N_visible_obstacles** is significantly **increaing** distance to the spaceship within distant fixations (0.00119524, 0.00300704).
